...
golem::fill_desc(
  pkg_name = "datacomparator", # The Name of the package containing the App 
...
usethis::use_mit_license( name = "Paul Campbell" )  # You can set another licence here
...
usethis::use_data_raw( name = "package_data", open = FALSE ) # Change "my_dataset"
